...
See also: [HOOKS.md](HOOKS.md) (when to add hooks vs skills/CI).
...
1. Copy `template/hooks/hooks.json.example` from the package repo to `.cursor/hooks.json` (or merge into an existing file).
